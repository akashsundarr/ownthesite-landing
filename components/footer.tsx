        ...
        >
          ...
          <div className="max-w-sm">
            ...
            <p className="text-base text-neutral-400 leading-relaxed font-medium">
              High-performance web applications that your business actually
              owns, controls, and scales with.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-12 md:gap-24">
            ...
            <div className="flex flex-col gap-5">
              ...
              <AnimatedLink
                href="mailto:hello@ownthesite.in"
              ...
              <AnimatedLink
                href="https://wa.me/918075920914?text=Hi%20OwnTheSite%20Team,%20I%20want%20to%20discuss%20a%20website%20project"
                className="text-base font-semibold text-neutral-300 hover:text-white transition-colors"
              >
                WhatsApp
              </AnimatedLink>
