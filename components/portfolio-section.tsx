...
export default function PortfolioSection() {
  ...
  return (
    <section ref={sectionRef} className="bg-[#F8F6F2] relative overflow-hidden">
      <div className="min-h-screen lg:h-screen w-full flex items-center max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-0">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start lg:items-center w-full h-full lg:pt-16">
          ...
          <div className="lg:w-1/3 shrink-0 z-50">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#1c232b] opacity-60 mb-6">
              Our Work
            </p>
            ...
            <p className="text-lg text-[#1c232b] opacity-70 mb-10 leading-relaxed max-w-sm">
              From educational institutions to landscaping, travel and
              engineering companies, we build digital experiences that convert
              visitors into customers.
            </p>
            <div className="lg:hidden flex items-center gap-1 justify-end mb-3 text-gray-500">
                  ...
                  <div className="flex flex-col gap-4 px-2 lg:opacity-0 lg:group-[.is-active]:opacity-100 transition-opacity duration-700 ease-out">
                    <div>
                      <div className="flex items-center gap-3 mb-2 lg:translate-y-4 lg:group-[.is-active]:translate-y-0 transition-transform duration-700 ease-out delay-75">
                        <h3 className="text-xl font-bold text-[#1c232b]">
                          {proj.title}
                        </h3>
                        <span className="px-2 py-1 bg-gray-100 text-[#1c232b] text-[10px] font-bold rounded-full">
                          {proj.year}
                        </span>
                      </div>
                      <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-3 lg:translate-y-4 lg:group-[.is-active]:translate-y-0 transition-transform duration-700 ease-out delay-100">
                        {proj.category}
                      </p>
                    ...
                    <div className="flex items-end justify-between mt-2">
                      ...
                      <div className="w-12 h-12 shrink-0 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 group-hover:border-[#1c232b] group-hover:bg-[#1c232b] group-hover:text-white transition-all duration-300">
                        <span className="material-symbols-outlined text-[20px] transform lg:rotate-0 lg:group-[.is-active]:rotate-45 lg:group-[.is-active]:hover:rotate-[55deg] transition-transform duration-500">
                          arrow_outward
                        </span>
                      </div>
                    </div>
